...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    npm install better-auth@1.4.7 @better-auth/expo@1.4.7 --save-exact
    ```
...
[step 4 of the React guide](https://convex-better-auth.netlify.app/framework-guides/react#set-environment-variables)
