...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    // If Better Auth uses a custom basePath, pass it here:
    // authComponent.registerRoutes(http, createAuth, { basePath: "/custom/auth" });
...
// If Better Auth uses a custom basePath, pass it here as well.
