...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    ```ts title="src/lib/convex/auth.ts"
  ...
  <div className="fd-step">
    ...
    ```ts title="src/lib/convex/http.ts"
...
Here's an example server action that calls the Convex function `getCurrentUser` from `src/lib/convex/auth.ts`.
