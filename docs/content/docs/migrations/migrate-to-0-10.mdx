...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    <Callout>
      Be sure to review the Better Auth 1.5 breaking changes before upgrading.
    </Callout>

    <Callout>
      Check your dependencies for Better Auth packages and be sure to pin them all to 1.5.3. For example if you're using @better-auth/expo, it should also be pinned to 1.5.3.
    </Callout>
